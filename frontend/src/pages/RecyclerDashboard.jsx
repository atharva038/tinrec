        ...
        <Box sx={{
            ...
            <Box
                ...
                sx={{
                    flexGrow: 1,
                    p: { xs: 2, sm: 3 },
                    mt: { xs: 8, md: 0 },  // Removed top margin to match screenshot
                    ml: 0,  // Important: Zero left margin to match screenshot
                    width: { xs: '100%', md: `calc(100% - ${220}px)` }, // Match the new sidebar width
                    transition: 'margin 0.3s ease',
                }}
            >
                <Container maxWidth="xl" disableGutters={isMobile} sx={{ pl: { xs: 0, md: 0 } }} // Remove padding-left to match screenshot
                >
                    <Typography
